...
void main() {
  late final ReadAllFinished usecase;
  ...
  setUp(() {
    ...
    usecase = ReadAllFinished(mockKanbanHistoryRepository);
  });

  test(
    'should return all finished kanbans in repository',
    () async {
      // arrange.
      when(mockKanbanHistoryRepository.readAllFinished()).thenAnswer(
      ...
      verify(mockKanbanHistoryRepository.readAllFinished());
