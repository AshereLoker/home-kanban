...
void main() {
  late final StopTimer usecase;
  late final MockTimerRepository mockTimerRepository;

  setUp(() {
    mockTimerRepository = MockTimerRepository();
    usecase = StopTimer(mockTimerRepository);
  });

  test(
    'should stop timer in repository',
    () async {
      // arrange.
      when(mockTimerRepository.stopTimer()).thenAnswer(
      ...
      verify(mockTimerRepository.stopTimer());
